package com.example.application.views.masterclubsdashboard;


import com.example.application.views.MainLayout;
import com.example.application.views.masterclubsdashboard.ServiceHealth.Status;
...
@PageTitle("Master Clubs Dashboard")
@Route(value = "master-clubs-dashboard", layout = MainLayout.class)
@RolesAllowed("ADMIN")
public class MasterClubsDashboardView extends Main {

    public MasterClubsDashboardView() {
        addClassName("master-clubs-dashboard-view");
